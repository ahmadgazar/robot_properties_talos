...
class TalosReducedMinimalRobot(PinBulletWrapper):
    '''
    Pinocchio-PyBullet wrapper class for the Talos torso + left leg (full) + right leg (full) +  Torso + left arm (with locked wrist and gripper) + right arm (with locked wrist and gripper) + locked head
    '''
    def __init__(self, pos=None, orn=None): 
        ...
        print("[pinbullet wrapper] REDUCED MINIMAL MODEL : ", self.pin_robot.model)
        ...
        super(TalosReducedMinimalRobot, self).__init__(
                    self.robotId, 
                    self.pin_robot,
                    controlled_joints,
